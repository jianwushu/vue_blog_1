        ...
        <div class="two fields">
          <div class="field">
            <div class="ui left labeled action input">
              ...
              <select v-model="blog.categoryId" name="category" class="ui fluid dropdown">
          ...
          <div class="field">
            <div class="ui left labeled action input">
              ...
              <div id="tag_dropdown" class="ui dropdown fluid selection multiple search ">
...
<script>
  // import * as req from "utils/api/admin/blog";
