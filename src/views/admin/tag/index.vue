    ...
    <div class="ui container">
      ...
      <table class="ui celled center aligned table">
        ...
        <tr>
          <th colspan="6">
            <div class="ui center aligned fluid labeled input">
              ...
              <input type="text" name="caName" placeholder="请输入新增标签名称" ref="newCategory">
        ...
        <tr v-for="(item,index) in data.slice(0,10)" :key="index">
          ...
          <td>待完善</td>
          <td>
            <button @click="editItem(item.id,index,item.tName)" class="ui mini teal basic button">编辑</button>
...
<script>
  ...
  // import * as req from "utils/api/admin/tag";
  ...
  export default {
    ...
    //         this.data.unshift({'id': res.id, 'tName': res.tName})
    //         this.totalElements++
    //         this.msg = "添加成功!"
    //       })
    //     }else{
